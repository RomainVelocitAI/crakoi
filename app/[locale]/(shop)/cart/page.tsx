      ...
      <div className="min-h-screen pt-24 bg-background">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-20">
          ...
          >
            ...
            <h1 className="font-serif text-3xl sm:text-4xl text-text-primary font-medium mb-4">
              {t("empty")}
            </h1>
    ...
    <div className="min-h-screen pt-24 bg-background">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-12 lg:py-20">
        ...
        <motion.h1
          ...
          className="font-serif text-3xl sm:text-4xl lg:text-5xl text-text-primary font-medium mb-12 lg:mb-16"
        >
          {t("title")}
        </motion.h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="min-w-0">
                      <Link
                        href={`/photos/${item.photoSlug}`}
                        className="font-serif text-base md:text-lg text-text-primary hover:text-gold transition-colors duration-300 line-clamp-1"
                      >
                        {item.photoTitle}
                      </Link>
                  ...
                  <div className="flex items-center justify-center">
                    <div className="inline-flex items-center border border-border rounded-lg overflow-hidden">
                      <button
                        ...
                        className="w-9 h-9 flex items-center justify-center text-text-muted hover:text-text-primary hover:bg-surface transition-colors"
                        aria-label="Decrease quantity"
                      >
                        <Minus className="w-3.5 h-3.5" />
                      </button>
                      <span className="w-10 h-9 flex items-center justify-center font-sans text-sm text-text-primary bg-surface/50 border-x border-border">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() =>
          ...
          <div className="lg:col-span-1">
            ...
            >
              <h2 className="font-serif text-xl text-text-primary font-medium mb-6">
                {t("summary")}
              </h2>
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="bg-surface-light hover:bg-border text-text-secondary hover:text-text-primary font-sans text-sm px-4 py-3 rounded-lg border border-border transition-colors duration-300">
                    {t("apply")}
                  </button>
                </div>
              </div>
